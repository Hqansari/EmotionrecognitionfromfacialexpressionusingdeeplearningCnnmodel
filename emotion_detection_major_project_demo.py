# -*- coding: utf-8 -*-
"""Emotion_detection_Major project_Demo.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1DZ6j2CfBYztzob5InPxAfoVKLC3oY6eR
...
gray_image= cv2.cvtColor(img, cv2.COLOR_BGR2GRAY) #converting the rgb image to grayscale
haar_cascade = cv2.CascadeClassifier(cv2.samples.findFile
                                    (cv2.data.haarcascades+"haarcascade_frontalface_default.xml"))
faces_detected = haar_cascade.detectMultiScale(gray_image) #detecting faces from the image using haar_cascade
for x,y,w,h in faces_detected: 
  cv2.rectangle(gray_image,(x,y), (x+w,y+h), (255,0,0))
